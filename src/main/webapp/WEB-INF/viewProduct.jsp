...
<html>
<head>
    <title>Grocery Store | Single</title>
    <!-- for-mobile-apps -->
    ...
    <div class="w3l_banner_nav_right">
        ...
        <div class="agileinfo_single">
            ...
            <div class="col-md-4 agileinfo_single_left">
                <img id="example" src="../images/${productById.img_url}" alt=" " class="img-responsive" />
            </div>
            <div class="col-md-8 agileinfo_single_right">
                ...
                <div class="snipcart-item block">
                    <div class="snipcart-thumb agileinfo_single_right_snipcart">
                        <h4>${productById.discount} ֏<span>${productById.price}</span></h4>
                    </div>
                    <div class="snipcart-details agileinfo_single_right_details">
                        <form action="#" method="post">
                            <fieldset>
                                ...
                                <input type="submit" name="submit" value="Ավելացնել զամբյուղ" class="button" />
                            </fieldset>
                        </form>
                    </div>
                </div>
